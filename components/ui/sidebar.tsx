...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex w-full flex-1 flex-col min-h-screen transition-[margin-left] duration-200 ease-linear",
        "ml-0 md:ml-[16rem] peer-data-[state=collapsed]:ml-0 md:peer-data-[state=collapsed]:ml-[3rem]",
